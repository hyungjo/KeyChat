    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <input type="hidden" name="email" value="${requestScope.email}">
                ...
                <br>
                <input type="submit" style="background: #000033; color: white;" class="col-xs-12 btn btn-load btn-lg" data-loading-text="Changing Password..." value="설정완료">
                <input type="reset" style="background: #000033; color: white;" class="col-xs-12 btn btn-load btn-lg" value="취소">
            </form>
        </div><!--/col-sm-6-->
    </div><!--/row-->
</div>
